...
import { Link } from "react-router-dom";
import { useSelector } from 'react-redux'; // Импорт хука useSelector из Redux Toolkit
...
function Header() {
    // Получение количества товаров в корзине из Redux состояния с помощью useSelector
